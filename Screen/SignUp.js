        ...
        <ImageBackground resizeMode='stretch' style={styles.containerForm} source={{ uri: "http://tingarciadg.com/wp-content/uploads/2021/05/pexels-sameera-ganegoda-2234783-scaled.jpg" }}>
            ...
            <View style={styles.containerBtns}>
                <View>
                    ...
                    >
                        Register and keep us always connected
                    </Text>
                </View>
                ...
                <TouchableOpacity onPress={() => logInFacebook()} style={styles.buttonFacebook} activeOpacity={0.5}>
                    ...
                    <Text style={{ color: 'white', fontFamily: 'Montserrat_700Bold' }}> Sign Up with Google </Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => { props.navigation.navigate('Sign In') }} style={styles.buttonSignIn} activeOpacity={0.5}>
                    <Text style={{ color: 'black', fontFamily: 'Montserrat_700Bold', fontSize: 20 }}> Sign in </Text>
                </TouchableOpacity>
            </View>
        </ImageBackground >
    )
