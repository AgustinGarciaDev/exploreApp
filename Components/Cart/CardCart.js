...
return <View key={ product._id } style={ styles.card }>
            ...
            <View style={ styles.secondContainer }>
                    ...
                    <View style={ styles.envioContainer }>
                        ...
                        <View style={ styles.buttonContainer }>
                            <Button buttonStyle={ styles.lessButton } titleStyle={ styles.lessTittle } title="-" />
                            <Text>{ product.units ? product.units : 0 }</Text>
                            <Button buttonStyle={ styles.plusButton } titleStyle={ styles.plusTittle } title ="+" />
                        </View>
                    </View>
            </View>
        ...
        <View style={ styles.tallaContainer }>
            ...
            <View style={{ flexDirection:"row" }}>
                <Button titleStyle={ styles.titleStyle } buttonStyle={ styles.buttonStyle } type="outline" title="Edit" />
                <Button titleStyle={ styles.titleStyle } buttonStyle={ styles.buttonStyle } type="outline" title="Remove" />
            </View>
        </View>
